...
"""
edx-manager-access-api documentation build configuration file.
...
project = 'edx-manager-access-api'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx-manager-access-api'
...
#
# html_title = 'edx-manager-access-api v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_manager_access_api'),
                os.path.join(root_path, 'edx_manager_access_api/migrations')])
